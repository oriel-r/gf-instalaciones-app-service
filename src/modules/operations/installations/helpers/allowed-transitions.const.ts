...
export const allowedTransitions = {
    ...
    [InstallationStatus.IN_PROCESS]: [InstallationStatus.POSTPONED, InstallationStatus.TO_REVIEW, InstallationStatus.CANCEL],
    [InstallationStatus.POSTPONED]: [InstallationStatus.FINISHED, InstallationStatus.CANCEL],

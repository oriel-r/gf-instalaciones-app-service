...
export const ordersMock = [
  {
    ...
    description:
      'Instalación de sistemas de seguridad en viviendas particulares.',
  },
  {
    orderNumber: 'ORD-002',
    title: 'Instalación corporativa',
    description:
      'Instalación de señalización y sistemas en oficinas corporativas.',
  },
  {
    orderNumber: 'ORD-003',
    title: 'Revisión integral',
    description:
      'Mantenimiento y revisión de instalaciones en locales comerciales.',
  },
  {
    orderNumber: 'ORD-004',
    title: 'Actualización tecnológica',
    description:
      'Modernización de sistemas e infraestructura en instituciones educativas.',
  },
  {
    orderNumber: 'ORD-005',
    title: 'Mantenimiento industrial',
    description:
      'Instalación y mantenimiento de equipos en plantas industriales.',
  },
  {
    orderNumber: 'ORD-006',
    title: 'Instalación de energía solar',
    description:
      'Implementación de sistemas de energía renovable en residencias.',
  },
  {
    orderNumber: 'ORD-007',
    title: 'Optimización de red',
    description:
      'Instalación y mejora de redes internas en oficinas y comercios.',
  },
  {
    orderNumber: 'ORD-008',
    title: 'Seguridad perimetral',
    description:
      'Instalación de cercas y sistemas de monitoreo para propiedades.',
  },
  {
    orderNumber: 'ORD-009',
    title: 'Mostaza',
...
export const createInstallationMocks = (orderTitle: string, count: number) => {
  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    const min = String(
      minArr[Math.floor(Math.random() * minArr.length)],
    ).padStart(2, '0');
